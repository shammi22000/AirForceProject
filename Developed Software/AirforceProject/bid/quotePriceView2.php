...
include ("../include_Connection.php");
 ...
 $sql ="SELECT * FROM bidquote";
 $result = mysql_query($sql, $conn) or die(mysql_error());

?> 


<!-- ////////////////////////////// start Display station Name////////////////////////////// -->     
      <?php
  	 error_reporting(E_ALL ^ E_NOTICE);
include ("../include_Connection.php");
...
?>
  ...
  <p align="left">Station Name :  <select name="SerStat">
	...
	?>
     </select>&nbsp;&nbsp; <input type="submit" name="seleStat" value="SELECT" /> </p>
<!-- ////////////////////////////// End Display Bidder Name////////////////////////////// --> 
...
<p align="left">  Category Name : <select name="SerCat">
	...
	?>
     </select>&nbsp; <input type="submit" name="Sersubmit" value="DISPLAY" /> </p>  <?php
 }
	?>
       ...
       <?php
			...
			$proYear=$_GET['Seryear'];
				...
				$statID=$_GET['SerStat'];
				 //echo  $proYear;
			$bidID=$_GET['comName'];
				//echo  $Id.$proYear.$statID.$bidID;

		include("../Include_Connection.php");
		$sql1 ="SELECT * FROM item, bidquote  WHERE (item.itemID=bidquote.bQitemID AND projYear='$projectYear' AND bQcatID='$Id' AND bQstaID='$statID')";
...
$actualQuantityTot=$actualQuantityTot+$newArray2['actualQuantity'];
 ...
 ?>
     <td align="right"> <?php echo $newArray1['subTot']; ?></td>
    <td align="center">
    <a href="quotePriceEdit.php?ID=<?php echo $newArray1['bidQuoteID']; ?>"><img src="../images/b_edit.png" width="16" height="16" alt="EDIT" border="0" /></a>&nbsp;&nbsp;  
      </td> 
    </tr>
	<?PHP  $a++; } ?>
<tr><td>&nbsp;</td>
...
<?php // retrieve Quoted Price===========================================
		...
		include("../Include_Connection.php");
		$sql3 = "SELECT bQSupId, sum(subTot)    FROM bidquote WHERE (bQstaID='$_GET[SerStat]' AND bQcatID='$_GET[SerCat]' AND  projYear='$projectYear'  )GROUP BY bQSupId "; 
  		echo $sql3;
     ...
     <td><?php echo $newArray3 ['sum(subTot)'];?> </td>
	<?PHP }?>
<td>&nbsp;</td> </tr>
</table>
 </h3>
