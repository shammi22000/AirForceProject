...
<table width="500" border="1" cellpadding="5" cellspacing="0" bgcolor="#EFEFEF" bordercolor="#CCCCCC">
   ...
   <tr class="p3">
         ...
         <td width="250">  <?php echo $newArray['busRegDate']; ?></td>         
   </tr>
  ...
  <tr class="p3">
         <td colspan="2" align="center">
          <a href="editProfile.php?ID=<?php echo $newArray['login_Id']; ?>"><input type="submit" name="edit" id="edit" value="Edit Profile"  /></a>
         </td>
 </tr>
 </table><br/>
</form>
