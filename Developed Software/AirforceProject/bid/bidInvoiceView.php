...
<h3 class="pageHeading">Payments for Bid - View Page </h3>
<!-- /////////////////////////////form1 starting////////////////////////////// --> 
...
<table width="750" border="1" cellspacing="0" cellpadding="5">
  ...
  <tr class="subtable2" >
    	...
    	<td width="300" bgcolor="#999999" >Selected Station</td>
    	<td width="300" bgcolor="#999999">Selected Category</td>
  ...
  <tr class="p3" >
        ...
        <td align="center">
    	<a href="bidInvoiceDelete.php?ID=<?php echo $newArray['bidId']; ?>"><img src="../images/b_drop.png" width="16" height="16" alt="DELETE" border="0" /></a> 
    	</td> 
  ...
  <tr align="center">
  		 ...
  		 <a href="bidInvoiceAdd.php"><input type="button" name="add" value="ADD ANOTHER" /></a> &nbsp;&nbsp;
   		<a href="printInvoice1.php" target="_new"> <input type="submit" name="print" value="PRINT INVOICE" /></a>
   		</td>
