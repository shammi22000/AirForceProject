...
<form name="form1"  method="get" action="<?php $_SERVER['PHP_SELF']?>">
 ...
 <!-- /////////////////////////////form1 ending////////////////////////////// --> 
     			...
     			<?php
	 				include("../Include_Connection.php");
					$id=$_GET['ID'];
					$sql = "SELECT * FROM  supplier WHERE supplierID='$bidID' ";
 					$result = mysql_query($sql, $conn) or die(mysql_error());
				 ?>
...
<table width="500" border="1" cellpadding="5" cellspacing="0" bgcolor="#EFEFEF" bordercolor="#CCCCCC">
   ...
   <tr class="p3">
    ...
    <tr class="p3" align="right">
          ...
          <td align="left">
            <input name="BusNature" type="text" id="BusNature" size="40" value="<?php echo $comName; ?> " /></td>
     </tr>
     <tr class="p3" align="right">
     ...
     <tr class="p3">
          ...
          <td>
            <textarea name="address" cols="25" rows="5"><?php echo $newArray['comAddress']; ?> </textarea></td>
     </tr>
     <tr class="p3">
          <td align="right">Telephone No</td>
          <td>
            <input name="tp1" type="text" id="tp1" size="25" value="<?php echo $newArray['TPNo1']; ?> " /><br/>
           <input name="tp2" type="text" id="tp2" size="25" value="<?php echo $newArray['TPNo2']; ?> " /> </td>
     </tr>
     <tr class="p3">
      ...
      <tr class="p3">
          ...
          <td><label for="pw"></label>
            <input name="pw" type="password" id="pw" size="25" value="<?php echo $newArray['email']; ?> "/></td>
      </tr>
