...
session_start(); 
	...
	if($_GET['submit']=="SUBMIT" || !empty($_GET['submit']) || isset($_GET['submit']) )
		...
		{ echo "check the document";
			include("../Include_Connection.php");
			$sql="SELECT * FROM paymentinvoice WHERE supID='$_GET[bidName]' AND proYear='$_GET[proYear]' AND  purpose='0'  ";
			$result = mysql_query($sql, $conn) or die(mysql_error());
			$numRow=mysql_num_rows($result);
	if($numRow>0)
			{	
				include("../Include_Connection.php");
				$sql2="UPDATE  paymentinvoice SET invoiceNo='11111', issDate='$_GET[issDate]', totAmount='$_GET[total]', todayDate='$_GET[currDate]' WHERE supID='$_GET[bidName]' AND proYear='$_GET[proYear]' AND purpose='0' ";
				...
				include("../Include_Connection.php");
				$sql1="INSERT INTO paymentinvoice (payInvoiID, supID, invoiceNo, issDate, totAmount, purpose, proYear, todayDate) VALUES ('', '$_GET[bidName]', '11111', '$_GET[issDate]', '$_GET[total]', '0', '$_GET[proYear]', '$_GET[currDate]') ";
...
<tr>
  ...
  <tr>
    	...
    	<td width="335"><strong><?php echo $_SESSION['name'];  ?></strong></td>
 ...
 <tr>
    	<td height="30"  valign="bottom" a>Issued Date:</td>
   		 <td><strong><?php $issueDate = date("d/m/y");  echo $issueDate; $today = date("F j, Y"); ?></strong>  </td>
     	<td>Due Date :<strong></strong>  </td> 
  </tr>
 <tr>
    	<td height="30"  valign="bottom">Purpose</td>
    	<td><strong>Pre-qualification Application Fee</strong></td>
 ...
 <!-- /////////////////////////////form1 ending////////////////////////////// --> 
   				...
   				<?php
	 			include("../Include_Connection.php");
				$sql = "SELECT * FROM   station, category, prequalificate WHERE station.stationId=prequalificate.stID AND category.catId=prequalificate.catId AND  	supId='$bidID' AND  projectYear='$projectYear' GROUP BY catName";
				$result = mysql_query($sql, $conn) or die(mysql_error());
				$numRow=mysql_num_rows($result);
		 		?>
...
<table border="1" cellpadding="5" cellspacing="0" width="700" bgcolor="#FFFFFF">
  ...
  <tr>
     	...
     	<td  align="right"><strong><?php $tot=$numRow*2000; echo "Rs.". $tot.".00";?></strong></td>
            ...
            <a href="bidInvoiceView.php"><input type="reset" value="Cancel" name="cancel"  /></a>
