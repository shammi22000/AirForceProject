...
<p class="pageHeading" >Appeals/Inquiries</p>
            
 <!--//////////////////////////////Start Form 1////////////////////////////// -->            
<form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="get" name="form1" >
<div class="container">
<table width="600" border="0" cellpadding="5" bgcolor="#CCCCCC" class="subtable3">
  ...
  <tr>
   ...
   <tr>
    ...
    <tr>
  		 <td colspan="2">
  		 <textarea name="txtdesc" cols="50" rows="10"></textarea>
  		 </td>
  </tr>
  <tr>
  		 <td>&nbsp;</td>
