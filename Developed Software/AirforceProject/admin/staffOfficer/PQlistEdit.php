...
{		$isQuali=$_GET['serQaul'];
	...
	include("../../Include_Connection.php");
	 $sql="UPDATE  prequalificate SET isQualified='$isQuali' WHERE (pqID='$_GET[preId]') ";
	//echo "<p>$sql</p>";
...
<!-- //////////////////////////////Sub Menu Ending////////////////////////////// --> 
    ...
    <h2><br/><br/>Pre-qualifed List Edit Page</h2>
 ...
 error_reporting(E_ALL ^ E_NOTICE);
		...
		$id=$_GET['ID'];
		 ...
		 $sql ="SELECT * FROM  station, category, supplier, prequalificate   WHERE (station.stationId=prequalificate.stID AND category.catId=prequalificate.catId AND supplier.supplierID=prequalificate.supId AND pqID='$id')";
