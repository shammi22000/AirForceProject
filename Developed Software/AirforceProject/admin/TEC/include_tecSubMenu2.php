...
#navigation {
    ...
    <body>
		<div id="navigation">
		    <ul class="top-level">
             <li>&nbsp;</li>
		        <li><a href="index.php" >TEC Home</a></li>
		        
		           </ul>
                
                </li>
		        <li><a href="categoryView.php">Category Info management</a>
                 	 </li>
		        <li>
		            <a href="stationView.php">Station Info Management</a>
		            <ul class="sub-level">
