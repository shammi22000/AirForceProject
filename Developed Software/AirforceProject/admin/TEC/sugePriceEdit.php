...
if($_GET['submit']=="UPDATE" || !empty($_GET['submit']) || isset($_GET['submit']))
{
	...
	$sql="UPDATE tecsuggest SET TECprice ='$_GET[price]' WHERE sugePriceID='$_GET[ID]'";
...
<!-- //////////////////////////////Sub Menu Ending////////////////////////////// --> 
    ...
    <td width="790" height="450" valign="top" align="center" bgcolor="#FFFFFF"><h2><br/>TEC suggested prices Edit page</h2>
      <?php
 $id=$_GET['ID'];
include ("../../include_Connection.php");
$sql = "SELECT * FROM item,tecsuggest WHERE (item.itemID=tecsuggest.sugeItemID AND sugePriceID='$id')"; 
 ...
 <div class="container">
  ...
  <tr>
   ...
   <tr>
    ...
    <td>
   <input name="price" type="text" value="<?php echo $newArray['TECprice']; ?>" />
    </td>
  </tr>
  ...
  <input type="hidden" name="ID" value="<?php echo $newArray['sugePriceID'];?>" />
  </td>
  </tr>
</table>
        </div>
