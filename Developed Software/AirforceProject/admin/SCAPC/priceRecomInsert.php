...
<!-- //////////////////////////////Sub Menu Ending////////////////////////////// --> 
   ...
   <td><?php $today = date("F j, Y, g:i a");  echo $today;?></td>
    ...
    <tr>
   <td>Minute Date :</td>
   <td><input name="MDate" type="text"  value="<?php echo $_GET['MDate']?>" /><span style="font-family:'Courier New', Courier, monospace; color:#999; font-size:10px;">(yyyy/MM/DD)Minute Date of Decision Given</span></td>
   </tr>
  <tr>
    <td>Project Year:</td>
    <?php
