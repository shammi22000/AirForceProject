...
<!-- //////////////////////////////Sub Menu Ending////////////////////////////// --> 
    ...
    <td width="790" valign="top" align="center" bgcolor="#FFFFCC" ><br/>    <p class="pageHeading" >TEC Recommended prices for  Each Bid</p>
 ...
 error_reporting(E_ALL ^ E_NOTICE);
include("../../Include_Connection.php");
		 $sql ="SELECT * FROM  tecrecommend GROUP BY  MinuteDate";
		  $result = mysql_query($sql, $conn) or die(mysql_error());
