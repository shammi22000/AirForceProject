  ...
  <tr>
   ...
   <!-- //////////////////////////////////////////////////////// --> 
	...
	include("../../Include_Connection.php");
	 $sql = "SELECT * FROM scapcsuggest GROUP BY year";
...
<?php  
 ...
 { 	?>
    ...
    <?php  }
	?>
    </select>&nbsp; <input type="submit" name="seleYear" value="Display" /></td>
	...
	if(isset($_GET['seleYear']))
{
 ...
 $Id= $_GET['serYear'];
include ("../../include_Connection.php");
$sql = "SELECT * FROM item,scapcsuggest WHERE (item.itemID=scapcsuggest.sugeItemID AND year='$Id')"; 
 $result = mysql_query($sql, $conn) or die(mysql_error()); 
 ?>
