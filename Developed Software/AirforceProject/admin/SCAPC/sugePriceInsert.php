 ...
 while ($newArray = mysql_fetch_array($result))
{
	...
	$year= $_GET['PurDate'];
	$sql="INSERT INTO scapcsuggest (sugePriceId, sugeItemID, year, 	SCAPCprice) VALUES ('', '$sugItemID', '$year', '$sugPrice')";
	echo $sql;
...
<!-- //////////////////////////////Sub Menu Ending////////////////////////////// --> 
    ...
    <p class="pageHeading" >SCAPC Suggests Prices</p>
  ...
  <tr>
   ...
   <form action="<?php echo $_SERVER['PHP_SELF'];  ?>" method="get" name="form1">
    <table width="500" border="0" cellpadding="5"  cellspacing="0" align="center" >
     <tr>
    	<td>Year</td> 
    	<td><input name="year" type="text" value="<?php echo $_GET['PurDate']; ?>" /></td>
    	 </tr> 
