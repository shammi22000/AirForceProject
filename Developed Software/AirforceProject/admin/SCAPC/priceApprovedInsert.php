...
include ("../../include_Connection.php");
	$sql1= "INSERT INTO scapcrecommend (SCAPCrecID, proYear, todayDate, MinuteDate, TRstaID, TRCatID, TRitemID, TRSupID, recomPrice) VALUES ('', '$year', '$currDate', '$minuteDate', '$StaID', '$CatID','$recPriceItemID', '$BidderID', '$recPrice' )";
	//echo $sql1;
...
<!-- //////////////////////////////Main Menu Ending////////////////////////////// --> 
 ...
 <!-- //////////////////////////////Main Menu Starting////////////////////////////// -->    
	<?php
	include("include_appPriceViewMenu.php");
	?>
<!-- //////////////////////////////Main Menu Ending////////////////////////////// --> 
...
<!-- //////////////////////////////Sub Menu Ending////////////////////////////// --> 
    ...
    <td width="790" valign="top" align="left" bgcolor="#FFFFCC">
     <h3 class="pageHeading" align="center">Price Approve Page</h3>
   ...
   <td><?php $today = date("d/m/Y");  echo $today;?></td>
    ...
    <tr>
   <td>Minute Date :</td>
   <td><div class="demo" style="padding:0px"><input  name="dof" type="text" id="datepicker" ?><span style="font-family:'Courier New', Courier, monospace; color:#999; font-size:10px;">Minute Date of Decision Given</span></div></td>
   </tr>
  <tr>
    <td>Project Year:</td>
    <?php
...
$newArray1 = mysql_fetch_array($result1);
 $suggPrice=$newArray1['SCAPCprice'];
 ?>
       <td  align="right"><?php echo $suggPrice; ?></td>
       
       <td  align="center"><input name="<?php echo $newArray['itemID']; ?>" type="text" value="<?php 
...
<input type="hidden" name="PurStation" value="<?php echo $_GET['seleStation']; ?>" />
        <input type="hidden" name="PurCat" value="<?php echo $_GET['SeleCat']; ?>" />
         ...
         <input type="hidden" name="MinuteDate" value="<?php echo $_GET['dof']; ?>" /><input type="hidden" name="proyear" value="<?php echo  $_GET['serYear']; ?>" />
         <input type="hidden" name="bidder" value="<?php echo $bidID; ?>" /><br/>&nbsp;&nbsp;
</form>
<?PHP  } ?>
</td>
   </tr>
