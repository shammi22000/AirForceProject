...
<table width="990"  height="650" border="1" cellspacing="0" cellpadding="0" class="maintable" bgcolor="#FFFF99">
 ...
 <tr>
  ...
  <tr>
    	...
    	<td width="790" valign="top" align="left" bgcolor="#FFFFFF"><h3 class="pageHeading" align="center">Documentary Evidence of Bidders</h3>
...
<!-- /////////////////////////////form2 starting////////////////////////////// --> 
<form name="form2"  method="get" action="<?php $_SERVER['PHP_SELF']?>" enctype="multipart/form-data">
...
<tr>
  ...
  <tr>
    	...
    	<a href="supplierDocEdit.php?ID=<?php echo $newArray['qualifiID']; ?>"><img src="../../images/b_edit.png" width="16" height="16" alt="EDIT" border="0" /></a>&nbsp;&nbsp;  &nbsp; &nbsp; 
    	<a href="supplierDocDelete.php?ID=<?php echo $newArray['qualifiID']; ?>"><img src="../../images/b_drop.png" width="16" height="16" alt="DELETE" border="0" /></a>
   	</td>
  </tr>
			<?PHP   } ?>
